                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    <figure><a><img src="/barcos3.jpg" alt="" /></a></figure>
                                    ...
                                    <audio className="w-100" controls src="/barco-sec1.mp3"></audio>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    <figure><a><img src="/barcos4.jpg" alt="" /></a></figure>
                                    ...
                                    <audio className="w-100" controls src="/barco-sec2.mp3"></audio>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    <figure><a><img src="/barcos1.jpg" alt="" /></a></figure>
                                    ...
                                    <audio className="w-100" controls src="/barco-sec3.mp3"></audio>
                                </div>
                            </div>
                        </div>
                    </div>
