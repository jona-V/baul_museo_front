                    ...
                    <div className="col-md-6 baul-item">
                        <div className="recent-work">
                            <div className="box_about">
                                <figure><a><img src="/maya-2.jpg" alt="" /></a></figure>
                                ...
                                <audio className="w-100" controls src="/maya-sec2.mp3"></audio>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 baul-item">
                        <div className="recent-work">
                            <div className="box_about">
                                <figure><a><img src="/cal-maya.jpg" alt="" /></a></figure>
                                ...
                                <audio className="w-100" controls src="/maya-sec4.mp3"></audio>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 baul-item">
                        <div className="recent-work">
                            <div className="box_about">
                                <figure><a><img src="/maya-1.jpg" alt="" /></a></figure>
                                <div className="ban">
                                    <a>Fuente: INAH</a>
                                </div>
                                ...
                                <audio className="w-100" controls src="/maya-sec1.mp3"></audio>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 baul-item">
                        <div className="recent-work">
                            <div className="box_about">
                                <figure><a><img src="/maya-3.jpg" alt="" /></a></figure>
                                <div className="ban">
                                    <a>Fuente: INAH</a>
                                </div>
                                ...
                                <audio className="w-100" controls src="/maya-sec3.mp3"></audio>
                            </div>
                        </div>
                    </div>
