    ...
    return (
        <div className="about">
            <div className="container">
                <h2>Edzná: Ciudad Maya entre las Selva</h2>
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <div className="ban">
                                        <a>Sobre este baúl: La gran acrópolis y la ciudad
                                            en desarrollo</a>
                                    </div>
                                    <p className="korem_text">Adéntrate en la gran Acrópolis, el núcleo monumental de Edzná. Desde sus modestos inicios
                                        hasta
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <div className="ban">
                                        <a>Sobre este baúl:La plaza principal y la
                                            función comunitaria</a>
                                    </div>
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <div className="ban">
                                        <a>Sobre este baúl: El laberinto y la ingeniería
                                            hidráulica</a>
                                    </div>
