    ...
    return (
        <div className="about">
            <div className="container">
                <h2>Chichén Itzá: Donde la Historia y la Arquitectura Maya Se Entrelazan</h2>
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <div className="ban">
                                        <a>Sobre este baúl: La pirámide de Kukulcán</a>
                                    </div>
                                    <p className="korem_text">Maravíllate ante la pirámide de Kukulcán, una obra maestra
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <p className="korem_text">Adéntrate en el Juego de pelota, un escenario de competiciones ceremoniales y rituales
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <div className="ban">
                                        <a>Sobre este baúl: El cenote sagrado y ofrendas a
                                            los dioses</a>
                                    </div>
                                    <p className="korem_text">Sumérgete en la espiritualidad maya en el cenote sagrado, un pozo natural donde se
                        ...
                        <div className="col-md-6 baul-item">
                            <div className="recent-work">
                                <div className="box_about">
                                    ...
                                    <div className="ban">
                                        <a>Sobre este baúl: El caracol y la observación
                                            astronómica</a>
                                    </div>
